...
func (p *ProductRepoMock) FindAllByUserId(userId int64) (
	products []models.Product, err error) {
	return
}

func (p *ProductRepoMock) FindById(productId int) (
...
func (p *ProductRepoMock) Update(product models.Product, productId int) (
